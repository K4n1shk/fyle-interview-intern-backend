...
class Assignment(db.Model):
    ...
    def grade_assignment(cls, _id, grade, principal: Principal):
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(assignment.teacher_id == principal.teacher_id, 'This assignment was not submitted to this teacher')
        ...
        if grade not in [g.value for g in GradeEnum]:
            raise ValidationError("Grade is not valid")
